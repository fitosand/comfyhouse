...
class Cards extends React.Component<AppProps2, StateVars> {
    ...
    return (
      <div>
        <div className="compTitle">
          {/* <button onClick={() => this.setState({ showCateg: true })}>
            back
          </button> */}
          <h3>Suscripciones</h3>
        </div>
              ...
              <div className="midLine">
                <div className="cardLeftItems">
                  ...
                  <div className="cardDetails">
                    <div className="businessName">Auto-lavado Makro</div>
                    <div className="cardDetails2 spc">
                      Lavado de carro, basico
                    </div>
                    <div className="cardDetailsPrice">$40,000/mes</div>
                  </div>
                </div>
                <div className="right darkG">
                  <FaChevronRight />
                </div>
              </div>
            ...
            <button className="businessCard">
              ...
              <div className="midLine">
                <div className="cardLeftItems">
                  <div className="boxIconLeft">logo</div>
                  <div className="cardDetails">
                    <div className="businessName">Suramericana</div>
                    <div className="cardDetails2 spc">Seguro de lavadora</div>
                    <div className="cardDetailsPrice">$40,000/mes</div>
                  </div>
                </div>
                <div className="right darkG">
